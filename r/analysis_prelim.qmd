...
here::i_am("r/analysis_prelim.qmd")
...
# ggsave(here("figures/prelim/data_dist.png"), device = "png", dpi = 300)
```
...
# ggsave(here("figures/prelim/method_gene_rmse.png"), device = "png", dpi = 300)
```
...
# ggsave(here("figures/prelim/method_mean_rmse.png"), device = "png", dpi = 300)
```
...
# ggsave(here("figures/prelim/method_gene_rmse_faceted.png"), device = "png", dpi = 300)
```
...
# ggsave(here("figures/prelim/method_gene_waveband.png"), device = "png", dpi = 300)
```
...
# ggsave(here("figures/prelim/gene_waveband.png"), device = "png", dpi = 300)
```
